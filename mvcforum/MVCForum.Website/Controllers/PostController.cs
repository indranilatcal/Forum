...
namespace MVCForum.Website.Controllers
{
	...
	public partial class PostController : BaseController
	{
		...
		public ActionResult CreatePost(CreateAjaxPostViewModel post)
		{
			...
			// Custom Code: Check if the user has rights to create post
			permissions = RoleService.GetPermissions(null, UsersRole);

			if (permissions[AppConstants.PermissionCreatePosts].IsTicked)
			{
				...
				throw new ApplicationException(LocalizationService.GetResourceString("Errors.NoPermission"));
		}
